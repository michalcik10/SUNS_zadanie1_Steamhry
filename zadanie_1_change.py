...
model.add(layers.Dense(53, input_shape=(x_train.shape[1],), activation='relu'))
model.add(layers.Dense(53, activation='relu'))
model.add(layers.Dense(53, activation='relu'))
model.add(layers.Dense(2, activation='sigmoid'))

adam = optimizers.Adamax(learning_rate=0.0001)
...
print(classification_report(y_test.values, y_predict_test))
